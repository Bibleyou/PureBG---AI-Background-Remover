              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                  ...
                  <p className="mt-4 text-lg text-gray-600">
                    Chega de perder horas no Photoshop. O PureBG faz o trabalho pesado para você.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  {[
                    {
                      title: "Ultra Preciso",
                      desc: "A IA do Gemini entende o contexto para preservar detalhes finos como cabelos e sombras.",
                      icon: (
                    ...
                    },
                    {
                      ...
                      desc: "Identifica automaticamente pessoas, animais e produtos com alta fidelidade.",
                      icon: (
                        <svg className="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    },
                    {
                      ...
                      desc: "Baixe suas imagens processadas em formato PNG transparente sem perda de qualidade.",
                      icon: (
                        <svg className="w-8 h-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
